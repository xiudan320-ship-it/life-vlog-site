...
function buildRouteControllerOptions({
  ...
  const settingsShellOptions = {
    elements,
    getSession,
    canViewSettingsItem: (item) => item?.id !== "adminStorageMeter" || Boolean(adminStorage.isAdmin?.()),
  ...
  return {
    ...
    moodDiary: {
      ...
      showToast,
      confirmAction,
      onMutation: onMoodMutation,
      openFamilySettings: () => elements.accountSettingsButton?.click(),
    },
    settings: {
      familySettings: {
        elements,
