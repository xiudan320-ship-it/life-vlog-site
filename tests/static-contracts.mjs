...
assert.match(serviceWorker, /life-vlog-site-20260826-002-pwa/);
...
assert.match(index, /app\.js\?v=20260826-002/);
...
assert.match(css, /shopping-card\s*\{[\s\S]*?grid-template-columns: 64px minmax\(0, 1fr\) 54px/);
