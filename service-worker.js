const CACHE_NAME = "life-vlog-site-20260827-007-ui";
...
const CORE_ASSETS = [
  ...
  "./styles/redesign-components.css?v=20260827-003",
  "./styles/content-forms.css?v=20260825-035",
  "./styles/mobile-diary.css?v=20260825-035",
  "./styles/mobile-page-shell.css?v=20260826-002",
  "./styles/account-dialogs.css?v=20260825-035",
  "./styles/secret-gallery.css?v=20260826-004",
  ...
  "./modules/app-feedback-view.js",
  "./modules/app-identity-controller.js",
  "./modules/app-navigation-controller.js?v=20260827-001",
  "./modules/app-session-controller.js?v=20260827-001",
  "./modules/auth-controller.js?v=20260827-001",
  "./modules/auth-view.js?v=20260827-001",
  ...
  "./modules/diary-metadata.js",
  "./modules/diary-gallery-view.js?v=20260824-032",
  ...
  "./modules/gamification-controller.js?v=20260826-002",
  ...
  "./modules/diary-feed-controller.js?v=20260824-032",
  ...
  "./modules/app-event-bindings.js?v=20260827-002",
  "./modules/content-form-event-bindings.js",
  "./modules/media-event-bindings.js",
  "./modules/settings-event-bindings.js?v=20260826-001",
  "./modules/profile-preferences-controller.js",
  "./modules/offline-records.js",
  "./modules/photo-favorites.js",
  "./modules/photo-dialog-view.js?v=20260826-001",
  "./modules/photo-viewer-controller.js?v=20260826-001",
  "./modules/photo-detail-controller.js?v=20260827-001",
  "./modules/photo-editor-controller.js",
  "./modules/mobile-diary-controller.js?v=20260827-001",
  "./modules/preferences-store.js",
  "./modules/push-controller.js",
  "./modules/recipe-controller.js",
  "./modules/recipe-view.js",
  "./modules/secret-domain.js?v=20260826-005",
  "./modules/secret-controller.js?v=20260826-001",
  "./modules/secret-composer-controller.js",
  "./modules/secret-album-actions-controller.js?v=20260826-001",
  ...
  "./modules/diary-composer-controller.js?v=20260827-001",
  "./modules/list-icons.js",
  "./modules/wishlist-view.js",
  "./modules/wishlist-controller.js",
  "./modules/wishlist-domain.js",
  "./modules/wishlist-interactions.js",
  "./modules/wishlist-hub-controller.js?v=20260826-001",
  "./modules/shopping-view.js",
  "./modules/shopping-controller.js?v=20260827-001",
  "./modules/shopping-domain.js",
  "./modules/shopping-interactions.js",
  "./modules/weekend-plans-view.js?v=20260827-004",
