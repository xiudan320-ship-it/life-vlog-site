const CACHE_NAME = "life-vlog-site-20260826-001-pwa";
...
const CORE_ASSETS = [
  ...
  "./styles/mobile-page-shell.css?v=20260826-001",
  "./styles/account-dialogs.css?v=20260825-035",
  "./styles/secret-gallery.css?v=20260825-035",
  ...
  "./styles/wishlist-compact.css?v=20260825-036",
  ...
  "./modules/secret-controller.js?v=20260825-003",
  "./modules/secret-composer-controller.js",
  "./modules/secret-album-actions-controller.js",
