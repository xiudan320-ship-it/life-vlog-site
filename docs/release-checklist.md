...
- 心情日记：`?page=mood` 深链接、当前月/跨月月历、今天与未来日期边界、共享八种心情 Picker、可留空正文、标签、自己的新建/编辑/删除、查看另一位成员、历史分页、Back 关闭、深浅色、键盘 Escape、焦点和 375/390/1440 宽度无溢出；确认页面只有一套 overlay，且 16 张素材无棋盘格、白边或裁切。
