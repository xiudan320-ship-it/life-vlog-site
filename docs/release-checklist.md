...
- 心情日记：`?page=mood` 深链接、当前月/跨月 4～6 周完整月历、今天与未来日期边界、月度玻璃心情罐（最多 62 枚）、每位成员最多心情、三档趋势与按日明细、共享八种心情 Picker、可留空正文、标签、自己的新建/编辑/删除、查看另一位成员、写后 canonical 重读、缓存错误重试、历史分页、Back 关闭、深浅色、趋势点键盘提示、reduced-motion、130% 字号和 375/390/430/768/844×390/1440 宽度无溢出；确认页面只有一套 overlay，且 16 张素材无棋盘格、白边或裁切。
